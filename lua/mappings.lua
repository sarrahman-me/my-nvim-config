...
map("n", "<leader>dn", function() vim.lsp.diagnostic.goto_next() end, { desc = "Go to next diagnostic" })
map("n", "<leader>dp", function() vim.lsp.diagnostic.goto_prev() end, { desc = "Go to previous diagnostic" })
...
map("n", "<leader>ca", function() vim.lsp.buf.code_action() end, { desc = "Code action (refactor, fix)" })
map("n", "<leader>f", function() vim.lsp.buf.format() end, { desc = "Format code" })
